...
var config = {
     ...
     * XMPP server
     */
    xmppURL: (window.location.protocol === "https:" ? "https:" : "http:") + "//im-api-v2-31.easemob.com/ws",
    // xmppURL: "im-api.easemob.com",
    ...
    apiURL: (window.location.protocol === "https:" ? "https:" : "http:") + "//a31.easemob.com",
    // apiURL: (location.protocol === 'https:' ? 'https:' : 'http:') + '//172.17.3.155:8080',
    /*
     * Application AppKey
     */
    //appkey: "easemob-demo#chatdemoui",
    appkey: "1125210322180330#tensquare",
